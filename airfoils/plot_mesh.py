...
renderView1.CameraPosition = [args.x_location, 0.0, 10.0]
renderView1.CameraFocalPoint = [args.x_location, 0.0, 0.0]
...
# save screenshot
SaveScreenshot("./airfoil_mesh.jpeg", renderView1, ImageResolution=[400, 300])
